			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/BackCharge/Input/insertBackCharge'?>" enctype="multipart/form-data">
							<div class="row">
												...
												<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<span class="input-icon">
																<input type="text" class="form-control" onkeyup="convert()" autocomplete="off" id="price" name="price" placeholder="0"/>
																<i class=""></i>
															</span>
														</div>
												</div><!-- /.span -->
