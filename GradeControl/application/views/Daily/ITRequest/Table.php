	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
              ...
              <!-- MAIN CONTENT BEGIN -->
								<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/ITRequest/Table/Filter'?>" enctype="multipart/form-data">
									</br>
									<div class="row">
												...
												<tbody>
													<?php foreach ($Table as $table): ?>
										              ...
										              <?php if ($this->session->userdata('roleGradeControl') == "1"): ?>
																		<a class="green" href="<?php echo base_url().'Daily/ITRequest/Update/pageUpdate/'.$table->id ?>">
          												...
          												<div class="modal-dialog" role="document">
          													<div class="modal-content">
          														...
          														<div class="modal-footer">
          															...
          															<a> <?php echo anchor('/Daily/ITRequest/Table/DeleteITRequest/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
          														</div>
          													</div>
          												</div>
  				                      </div>
