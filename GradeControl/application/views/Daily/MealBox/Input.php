	...
	<body class="no-skin" onload="Enabler()">
			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/Mealbox/Input/insertMealBox'?>" enctype="multipart/form-data">
							<div class="row">
									...
									<div class="col-xs-6 col-sm-6">
										<div class="col-xs-6 col-sm-6">
											...
											<div class="form-group">
													...
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<input type="text" class="form-control" autocomplete="off" onkeyup="checker()" id="pagi" name="pagi" value=""/>
													</div>
											</div><!-- /.span -->
											<div class="form-group">
												</br>
													...
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<input type="text" class="form-control" autocomplete="off" onkeyup="checker()" id="siang" name="siang" value=""/>
													</div>
											</div><!-- /.span -->
											<div class="form-group">
												</br>
													...
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<input type="text" class="form-control" autocomplete="off" onkeyup="checker()" id="malam" name="malam" value=""/>
													</div>
											</div><!-- /.span -->
											<div class="form-group">
											</br>
										...
										<div class="col-xs-6 col-sm-6">
												...
												<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<input type="number" class="form-control" readonly autocomplete="off" id="total" name="total" placeholder="0"/>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
												</br>
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<span class="input-icon">
																<input type="number" class="form-control" readonly autocomplete="off" id="dollars" name="dollars" placeholder="0"/>
		...
		<script>
			...
			function checker(){
				...
				var x = total.value / <?php echo $Currency; ?>;
				var y = x.toFixed(2)
				dollars.value = y;
			}
