				...
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<?php foreach ($Table as $table): ?>
							<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PengambilanBarang/Update/updatePengambilanBarang/'.$id?>" enctype="multipart/form-data">
								<div class="row">
											...
											<div class="form-group">
												<div class="col-xs-6 col-sm-6"></br>
													<div class="form-group">
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<select class="form-control" id="jenis" onchange="label()" name="jenis" data-placeholder="Choose a category">
																	<option value="SIR" <?php if("SIR" == $table->jenis){echo "selected = true";} ?>>SIR</option>
																	<option value="PS" <?php if("PS" == $table->jenis){echo "selected = true";} ?>>PS</option>
																</select>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
															<label class="col-sm-3 control-label no-padding-right" for="form-field-1" id="label"> No. SIR/PS </label>
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														...
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<span class="input-icon">
																		<input type="text" class="form-control" onkeyup="convert()" autocomplete="off" id="cost" name="cost" value="<?php echo $table->cost ?>"/>
																		<i class=""></i>
																	</span>
																</div>
														</div><!-- /.span -->
