			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/WorkOrder/Update/updateWorkOrder/'.$id?>" enctype="multipart/form-data">
									...
									<div class="form-group">
										<div class="col-xs-5 col-sm-5" style="text-align:center">
											<div class="form-group">
													...
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<textarea class="form-control" id="form-field-8" id="job" name="job" rows="4"><?php echo $table->job;?></textarea>
													</div>
											</div><!-- /.span -->
