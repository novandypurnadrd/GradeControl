	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
              ...
              <!-- MAIN CONTENT BEGIN -->
								<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/Mealbox/Table/Filter'?>" enctype="multipart/form-data">
									</br>
									<div class="row">
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<?php foreach ($Table as $table): ?>
														<?php
															$originalDate = $table->date;
															$newDate = date("d-M-Y", strtotime($originalDate));
														 ?>
														<tr>
															<td><?php echo $newDate ?></td>
															<td><?php echo $table->pagi ?></td>
															<td><?php echo $table->siang ?></td>
															<td><?php echo $table->malam ?></td>
															<td><?php echo "Rp.". number_format($table->price, "2", ",",".").", -" ?></td>
															<td><?php echo "Rp.". number_format($table->total, "2", ",",".").", -" ?></td>
										              ...
										              <?php if ($this->session->userdata('roleGradeControl') == "1"): ?>
																		<a class="green" href="<?php echo base_url().'Daily/MealBox/Update/pageUpdate/'.$table->id ?>">
          												...
          												<div class="modal-dialog" role="document">
          													<div class="modal-content">
          														...
          														<div class="modal-footer">
          															...
          															<a> <?php echo anchor('/Daily/MealBox/Table/DeleteMealBox/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
          														</div>
          													</div>
          												</div>
  				                      </div>
