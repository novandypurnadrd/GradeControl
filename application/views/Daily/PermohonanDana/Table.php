	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
              ...
              <!-- MAIN CONTENT BEGIN -->
								<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PermohonanDana/Table/Filter'?>" enctype="multipart/form-data">
									</br>
									<div class="row">
												...
												<tbody>
													<?php foreach ($Table as $table): ?>
														<?php
															...
															$datecomplete = $table->datecomplete;
															if ($datecomplete != null) {
																$datecomplete = date("d-M-Y", strtotime($datecomplete));
															}
															else {
																$datecomplete = "";
															}
														...
														<tr>
															...
															<td><?php echo $table->costcode ?></td>
															<td><?php echo $table->perihal ?></td>
															<td>
															...
															<td><?php echo "Rp.". number_format($table->cost, "2", ",",".").", -" ?></td>
															<td><?php echo "$". number_format($table->dollars, "2", ".",",") ?></td>
															<td><?php echo $datecomplete ?></td>
															<td>
																<?php if($table->file != ""){ ?>
																	<a target="_blank" href="<?php echo base_url().$table->file ?>"><?php echo explode('/',$table->file)[3]; ?></a>
																<?php } ?>
                              </td>
															<td>
																<div class="action-buttons">
										              <?php if ($this->session->userdata('roleGradeControl') == "1"): ?>
																		<a class="green" href="<?php echo base_url().'Daily/PermohonanDana/Update/pageUpdate/'.$table->id ?>">
          												...
          												<div class="modal-dialog" role="document">
          													<div class="modal-content">
          														...
          														<div class="modal-footer">
          															...
          															<a> <?php echo anchor('/Daily/PermohonanDana/Table/DeletePermohonanDana/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
          														</div>
          													</div>
          												</div>
  				                      </div>
