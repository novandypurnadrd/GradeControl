	...
	<body class="no-skin" onload="myFunction()">
			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PermohonanDana/Update/updatePermohonanDana/'.$id?>" enctype="multipart/form-data">
											...
											<div class="form-group">
												<div class="col-xs-6 col-sm-6"></br>
													<div class="form-group">
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<input type="text" class="form-control" autocomplete="off" id="no" name="no" value="<?php echo $table->no;?>"/>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
													...
													<div class="form-group">
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<select class="form-control" id="status" onchange="myFunction()" name="status" data-placeholder="Choose a category">
																	<option value="0" <?php if($table->status == "0"){echo "selected = true";} ?>>Progress</option>
																	<option value="1" <?php if($table->status == "1"){echo "selected = true";} ?>>Completed</option>
																	<option value="2" <?php if($table->status == "2"){echo "selected = true";} ?>>Cancel</option>
																</select>
															</div>
													</div><!-- /.span -->
													<div class="form-group"></br>
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<textarea class="form-control" id="form-field-8" id="perihal" name="perihal" rows="4"><?php echo $table->perihal ?></textarea>
															</div>
													</div><!-- /.span -->
													<?php if ($table->file == "") { ?>
														<div class="form-group">
												...
												<div class="col-xs-6 col-sm-6"></br>
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<span class="input-icon">
																		<input type="text" class="form-control" required="on" onkeyup="convert()" autocomplete="off" id="cost" name="cost" value="<?php echo $table->cost;?>"/>
																		<i class=""></i>
																	</span>
																</div>
														</div><!-- /.span -->
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<span class="input-icon">
																		<input type="text" class="form-control" readonly autocomplete="off" id="dollars" name="dollars" value="<?php echo $table->dollars;?>"/>
		...
		<script>
			...
			function convert() {
				...
				var x = cost.value / <?php echo $Currency; ?>;
				var y = x.toFixed(2)
				dollars.value = y;
			}
		</script>
