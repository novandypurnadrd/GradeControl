			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PermohonanDana/Input/insertPermohonanDana'?>" enctype="multipart/form-data">
							<div class="row">
										...
										<div class="form-group">
											<div class="col-xs-6 col-sm-6"></br>
												<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<input type="text" class="form-control" autocomplete="off" id="no" name="no" value=""/>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
													</br>
												...
												<div class="form-group"></br>
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<textarea class="form-control" id="form-field-8" id="perihal" name="perihal" rows="4"></textarea>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
												</br>
