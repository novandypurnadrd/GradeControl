			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PurchaseRequest/Update/updatePurchaseRequest/'.$id?>" enctype="multipart/form-data">
									...
									<div class="form-group">
										<div class="col-xs-5 col-sm-5">
											...
											<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<div class="input-group">
																		<input class="form-control date-picker" disabled="true" required id="id-date-picker-2" required="on" autocomplete="off" name="datecomplete" type="text" data-date-format="yyyy-mm-dd" value="<?php echo $table->datecomplete; ?>" />
																		<span class="input-group-addon">
																			<i class="fa fa-calendar bigger-110"></i>
																		</span>
																	</div>
										...
										<div class="col-xs-7 col-sm-7">
											<div class="form-group">
												<div class="col-xs-6 col-sm-6"></br>
													<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-1">No. Pronto</label>
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<input type="text" class="form-control" required="on" autocomplete="off" id="no" name="no" value="<?php echo $table->no; ?>"/>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<input type="text" class="form-control" required="on" autocomplete="off" id="costcode" name="costcode" value="<?php echo $table->costcode; ?>"/>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
															<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Barang </label>
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<textarea class="form-control" id="form-field-8" id="jenisbarang" name="jenisbarang" rows="3"><?php echo $table->jenisbarang; ?></textarea>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> QTY </label>
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<input type="text" class="form-control" required="on" autocomplete="off" id="qty" name="qty" value="<?php echo $table->qty; ?>"/>
														</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<select class="form-control" onchange="Enabler()" id="form-field-select-3" name="uom" data-placeholder="Select UOM">
												...
												<div class="col-xs-6 col-sm-6"></br>
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<input type="text" class="form-control" autocomplete="off" id="po" name="po" value="<?php echo $table->po; ?>"/>
																</div>
														</div><!-- /.span -->
														<div class="form-group">
															</br>
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<input type="text" class="form-control" autocomplete="off" id="itemcode" name="itemcode" value="<?php echo $table->itemcode; ?>"/>
																</div>
														</div><!-- /.span -->
														<div class="form-group">
															</br>
																<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis PR </label>
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<select class="form-control" id="pr" name="pr" data-placeholder="Choose a category">
																		<option value="1" <?php if("1" == $table->pr){echo "selected = true";} ?>>Pronto</option>
																		<option value="2" <?php if("2" == $table->pr){echo "selected = true";} ?>>Manual</option>
																	</select>
																</div>
														</div><!-- /.span -->
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<select class="form-control" id="status" onchange="myFunction()" name="status" data-placeholder="Choose a category">
																		<option value="0" <?php if("0" == $table->status){echo "selected = true";} ?>>Progress</option>
																		<option value="1" <?php if("1" == $table->status){echo "selected = true";} ?>>Completed</option>
																		<option value="2" <?php if("2" == $table->status){echo "selected = true";} ?>>Cancel</option>
																	</select>
																</div>
														</div><!-- /.span -->
													<?php if ($table->file == "") { ?>
													...
													<?php }
														...
														<div class="form-group">
																...
																<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																	<input type="text" hidden name="prevfile" value="<?php echo $table->file ?>">
																	<a  target="_blank" href="<?php echo base_url().$table->file ?>">Preview File!</a>
																</div>
														</div><!-- /.span -->
													<?php }?>
												</div>
											...
											<div class="form-group">
												<div class="col-xs-12 col-sm-12" style="text-align:center"></br>
													<button type="submit" id="submit" disabled class="btn btn-sm btn-primary">
