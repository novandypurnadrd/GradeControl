			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/PurchaseRequest/Input/insertPurchaseRequest'?>" enctype="multipart/form-data">
							<div class="row">
								<div class="form-group">
									<div class="col-xs-5 col-sm-5">
										...
										<div class="form-group">
												...
												<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
													<textarea class="form-control" id="form-field-8" id="keterangan" name="keterangan" rows="4"></textarea>
												</div>
										</div><!-- /.span -->
									</div>
										...
										<div class="form-group">
											<div class="col-xs-6 col-sm-6"></br>
												...
												<div class="form-group">
														...
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<textarea class="form-control" id="form-field-8" id="jenisbarang" name="jenisbarang" rows="3"></textarea>
														</div>
												</div><!-- /.span -->
												<div class="form-group">
													<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> QTY </label>
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<input type="text" class="form-control" required="on" autocomplete="off" id="qty" name="qty" value=""/>
													</div>
												</div><!-- /.span -->
												<div class="form-group">
													</br>
											...
											<div class="col-xs-6 col-sm-6"></br>
													<div class="form-group">
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<input type="text" class="form-control" autocomplete="off" id="po" name="po" value=""/>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
															...
															<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
																<input type="text" class="form-control" autocomplete="off" id="itemcode" name="itemcode" value=""/>
															</div>
													</div><!-- /.span -->
													<div class="form-group">
														</br>
