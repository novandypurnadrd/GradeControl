			...
			<div class="main-content">
				<div class="main-content-inner">
                  ...
                  <small>
						...
						<!-- MAIN CONTENT BEGIN -->
						<form class="form-horizontal" method="post" action="<?php echo base_url().'Daily/ITRequest/Input/insertITRequest'?>" enctype="multipart/form-data">
							<div class="row">
								<div class="form-group">
									<div class="col-xs-5 col-sm-5">
										...
										<div class="form-group">
											...
											<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Jenis Request </label>
											<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
												<input type="text" class="form-control" required="on" autocomplete="off" id="rincian" name="rincian" value=""/>
											</div>
										</div><!-- /.span -->
										<div class="form-group">
											</br>
										...
										<div class="form-group">
											<div class="col-xs-6 col-sm-6"></br>
												...
												<div class="form-group">
													...
													<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
														<input type="text" class="form-control" required="on" onkeyup="convert()" autocomplete="off" id="qty" name="qty" value=""/>
													</div>
												</div><!-- /.span -->
												<div class="form-group">
													</br>
											...
											<div class="col-xs-6 col-sm-6"></br>
												<div class="form-group">
														<label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Cost (Rp.) </label>
														<div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
															<span class="input-icon">
																<input type="text" class="form-control" required="on" onkeyup="convert()" autocomplete="off" id="cost" name="cost" placeholder="0"/>
																<i class=""></i>
															</span>
														</div>
												</div><!-- /.span -->
