      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h1 class="text-primary">Ore Inventory</h1>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END INTRO -->
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="card">
									<div class="card-body">
										<form class="form" role="form" action="<?php echo base_url().'Oreline/Table/Filter' ?>" method="post">
									...
									<div class="card-body">
										<div class="row">
											<div class="col-md-12 col-lg-12 col-xl-12">
											 ...
											 <form class="form-horizontal" role="form" action ="<?php echo base_url('Oreline/Table/Delete_multiple'); ?>" method="post">
											<div class="col-lg-12">
										...
										<th>Actual Ton</th>
														...
														<tbody>
															<?php foreach ($Table as $table) {
																$Date = date("d-F-Y", strtotime($table->recdate)); ?>
																<tr class="gradeX">
																<td><center> <div class="">
																	...
																	<div class="modal-dialog" role="document">
																		<div class="modal-content">
																			...
																			<div class="modal-footer">
																				...
																				<a> <?php echo anchor('Oreline/Table/DeleteOreline/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
																			</div>
																		</div>
																	</div>
																</div>
