      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<!-- BEGIN TITLE -->
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'Oremined/Input/InputOremined' ?>" method="post">
  						<div class="row">
  							<div class="col-lg-6">
  							...
  							<div class="col-md-6 col-sm-6">
  								<div class="card">
		                            ...
		                            <?php foreach ($Oreline as $oreline): ?>
		                              <option value="<?php echo $oreline->id ?>" class="<?php echo $oreline->pit ?>"><?php echo $oreline->id ?></option>
		                            <?php endforeach; ?>
		  												</select>
														</div>
													</div>
												...
												<div class="form-group">
													<div class="col-md-6 col-sm-6">
														...
														<div class="col-sm-8">
															<input type="text" class="form-control" id="RL" name="RL" readonly="" autocomplete="off">
														</div>
													</div>
												</div>
											</div>
  										...
  										<div class="form-horizontal">
												<div class="form-group">
  												<div class="col-md-4 col-sm-4">
  													...
  													<div class="col-sm-8">
  														<input type="text" class="form-control" id="TruckTally" name="TruckTally" required="" autocomplete="off">
  													</div>
  												</div>
													<div class="col-md-4 col-sm-4">
                                ...
                                <?php endforeach; ?>
												...
												<div class="form-group">
													...
													<div class="col-md-4 col-sm-4">
  													...
  													<div class="col-sm-8">
  														<input type="text" class="form-control" id="Note" name="Note" disabled autocomplete="off">
  													</div>
  												</div>
  											</div>
  										</div>
