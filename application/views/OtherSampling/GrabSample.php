...
<html lang="en">
      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<!-- BEGIN TITLE -->
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/GrabSample/InputGrabSample' ?>" method="post">
  						<div class="row">
  							<div class="col-lg-6">
  								<h2 class="text-primary">Grab Sample</h2>
  							</div><!--end .col -->
                        ...
                        <div class="form-group">
                          <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-2 control-label">From GS</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="fromgs" name="fromgs" required="">
                                </div>
                           ...
                           <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-4 control-label">To GS</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="togs" name="togs" onkeyup="TotalSample()" required="">
                                </div>
                        ...
                        <div class="form-group">
                          <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-2 control-label">Remarks</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
            ...
            <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="card">
                  <div class="card-body">
                   <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/GrabSample/Filter' ?>" method="post">
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-12 col-lg-12 col-xl-12">
                       ...
                       <form class="form-horizontal" role="form" action ="<?php echo base_url('OtherSampling/GrabSample/Delete_multiple'); ?>" method="post">
                      <div class="col-lg-12">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr class="gradeX">
                                  ...
                                  <td><?php echo $table->FromGS; ?></td>
                                  <td><?php echo $table->ToGS; ?></td>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a> <?php echo anchor('OtherSampling/GrabSample/DeleteGrabSample/'.$table->Id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
   ...
   <script src="<?php echo base_url();?>assets/js/libs/jquery/jquery-1.11.2.min.js"></script>
    ...
    <script type="text/javascript">
        ...
        var From = document.getElementById("fromgs");
        var To =  document.getElementById("togs");
