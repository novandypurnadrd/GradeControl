    ...
    <div id="base">
      ...
      <div id="content">
            ...
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/GrabSample/InputGrabSample' ?>" method="post">
                        ...
                        <div class="form-group">
                          <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-4 control-label">From GS</label>
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="fromgs" name="fromgs">
                                </div>
                           ...
                           <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="togs" name="togs" onkeyup="TotalSample()">
                                </div>
