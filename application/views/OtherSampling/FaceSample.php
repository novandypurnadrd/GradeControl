      ...
      <div id="content">
        <section>
          <div class="section-body contain-lg">
            ...
            <!-- BEGIN TITLE -->
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/FaceSample/InputFaceSample' ?>" method="post">
              <div class="row">
                <div class="col-lg-6">
                  <h2 class="text-primary">Face Sample</h2>
                </div><!--end .col -->
                  ...
                  <div class="card">
                    <div class="card-body">
                      <div class="form-horizontal">
                            ...
                            <div class="col-sm-8">
                              <div class="input-group date" id="demo-date">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="Date" name="Date" required="" autocomplete="off" value="<?php echo $date?>" required>
                                </div>
                        ...
                        <div class="form-group">
                           <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-2 control-label">From FS</label>
                            <div class="col-sm-8">
             ...
             <div class="row">
              <div class="col-md-6 col-sm-6">
                <div class="card">
                  <div class="card-body">
                 <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/FaceSample/Filter' ?>" method="post">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <form class="form-horizontal" role="form" action ="<?php echo base_url('OtherSampling/FaceSample/Delete_multiple'); ?>" method="post">
                      <div class="col-lg-12">
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a> <?php echo anchor('OtherSampling/FaceSample/DeleteFaceSample/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
