      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<!-- BEGIN TITLE -->
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/RCDrilling/InputRCDrilling' ?>" method="post">
  						<div class="row">
  							<div class="col-lg-6">
  								<h2 class="text-primary">RC Drilling</h2>
  							</div><!--end .col -->
                          ...
                          <div class="col-md-3 col-sm-3">
                           ...
                           <div class="col-md-3 col-sm-3">
                            ...
                            <label for="DryTonFF" class="col-sm-4 control-label">Total Meter</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="totalmeter" name="totalmeter" required>
                                </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3">
                           ...
                           <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-2 control-label">To Hole ID</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
                           ...
                           <div class="col-md-2 col-sm-2">
                            <label for="totalsample" class="col-sm-4 control-label">Drill</label>
                            <div class="col-sm-8">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="drill" name="drill" >
                                </div>
                          ...
                          <div class="col-md-3 col-sm-3">
                           ...
                           <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="tosample" name="tosample" required onkeyup="TotalSample()" >
                                </div>
              ...
              <div class="col-md-6 col-sm-6">
                <div class="card">
                  <div class="card-body">
                  <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/RCDrilling/Filter' ?>" method="post">
                  ...
                  <div class="card-body">
                    <div class="row">
                      <div class="col-md-12 col-lg-12 col-xl-12">
                        ...
                        <form class="form-horizontal" role="form" action ="<?php echo base_url('OtherSampling/RCDrilling/Delete_multiple'); ?>" method="post">
                      <div class="col-lg-12">
                              ...
                              ?>
                                <tr class="gradeX">
                                 <td><center> <div class="">
                                  ...
                                  <td><?php echo $table->TotalMeter; ?></td>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a> <?php echo anchor('OtherSampling/RCDrilling/DeleteRCDrilling/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
