...
<html lang="en">
      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<!-- BEGIN TITLE -->
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/StockpileSample/InputStockpileSample' ?>" method="post">
  						<div class="row">
  							<div class="col-lg-6">
  								<h2 class="text-primary">Stockpile Sample</h2>
  							</div><!--end .col -->
                          ...
                          <div class="col-md-3 col-sm-3">
                           ...
                           <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-4 control-label">From ST</label>
                            <div class="col-sm-4">
                           ...
                           <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-4 control-label">To ST</label>
                            <div class="col-sm-4">
                              <div class="input-group">
                                <div class="input-group-content">
                        ...
                        <div class="form-group">
                        <div class="col-md-3 col-sm-3">
                            <label for="DryTonFF" class="col-sm-3 control-label">Remarks</label>
                            <div class="col-sm-4">
                              <div class="input-group">
                                <div class="input-group-content">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="row">
                      ...
                      <form class="form-horizontal" role="form" action ="<?php echo base_url('OtherSampling/StockpileSample/Delete_multiple'); ?>" method="post">
                      <div class="col-lg-12">
                              ...
                              ?>
                                ...
                                <td><center> <div class="">
                                 ...
                                 <!--  <?php //if ($this->session->userdata('roleGradeControl') == "Admin" || $this->session->userdata('GE')): ?>
                                  ...
                                  <?php //endif; ?> -->
                                  <td><?php echo $Date; ?></td>
                                  <td><?php echo $table->FromST; ?></td>
                                  <td><?php echo $table->ToST; ?></td>
                                  ...
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-footer">
                                        ...
                                        <a> <?php echo anchor('OtherSampling/StockpileSample/DeleteStockpileSample/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
                                      </div>
                                    </div>
                                  </div>
                                </div>
 ...
 -->
     <script type="text/javascript">
        ...
        var From = document.getElementById("fromst");
        var To =  document.getElementById("tost");
