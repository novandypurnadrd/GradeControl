          ...
          <div class="section-body contain-lg">
            ...
            <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/AcidSample/InputAcidSample' ?>" method="post">
                       ...
                       <div class="col-md-3 col-sm-3">
                           ...
                           <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="toholeid" name="toholeid" onkeyup="TotalHole()" required="">
                                </div>
                          ...
                          <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="totalhole" name="totalhole" readonly="">
                                </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-3 col-sm-3">
                            ...
                            <div class="col-sm-6">
                              <div class="input-group">
                                <div class="input-group-content">
                                  <input type="text" class="form-control" id="totalsample" name="totalsample" readonly="">
                                </div>
              ...
              <div class="col-md-6 col-sm-6">
                <div class="card">
                  <div class="card-body">
                   <form class="form" class="form-horizontal" role="form" action="<?php echo base_url().'OtherSampling/AcidSample/Filter' ?>" method="post">
