                      ...
                      <div class="form-horizontal">
                            ...
                            <div class="col-sm-8">
                              <select id="Block" name="Block" class="form-control" required="" onchange="BlockChange()" required="">
                                ...
                                <?php foreach ($Oreline as $oreline): ?>
                                  <option value="<?php echo $oreline->id ?>" class="<?php echo $oreline->pit ?>"><?php echo $oreline->File ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                          </div>
                        ...
                        <div class="form-group">
                          <div class="col-md-6 col-sm-6">
                            ...
                            <div class="col-sm-8">
                              <input type="text" class="form-control" id="RL" name="RL" autocomplete="off">
                            </div>
                          </div>
                        </div>
                        <br>
