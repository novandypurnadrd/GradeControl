      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h1 class="text-primary">Prospect</h1>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END INTRO -->
						...
						<div class="row">
							<div class="col-md-12 col-sm-12">
								<div class="card">
									<div class="card-body">
										<form class="form" role="form" action="<?php echo base_url().'References/Prospect/InputProspect' ?>" method="post">
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group floating-label">
  												...
  												<label for="regular2">Nama Prospect</label>
  											</div>
                      </div>
                      <div class="col-md-1 col-lg-1 col-xl-1">
                      ...
                      <div class="col-md-3">
						...
						<div class="row">
							...
							<form class="form-horizontal" role="form" action ="<?php echo base_url('References/Prospect/Delete_multiple'); ?>" method="post">
							<div class="col-lg-12">
								<div class="table-responsive">
									<table id="datatable1" class="table table-striped table-hover">
										<thead>
											<tr>
											  <th width="75px"><center> <div class="checkbox checkbox-danger">
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<a> <?php echo anchor('References/Prospect/Delete/'.$table->Id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
															</div>
														</div>
													</div>
												</div>
