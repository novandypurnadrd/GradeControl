      ...
      <div id="content">
				<section>
					<div class="section-body contain-lg">
						...
						<div class="row">
							<div class="col-lg-12">
								<h1 class="text-primary">STOCKPILE</h1>
							</div><!--end .col -->
						</div><!--end .row -->
						<!-- END INTRO -->
						...
						<div class="row">
							<div class="col-md-12 col-lg-12 col-xl-12">
								<div class="card">
									<div class="card-body">
										<form class="form" role="form" action="<?php echo base_url().'References/Stockpile/InputStockpile' ?>" method="post">
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6">
                        <div class="form-group floating-label">
  												...
  												<label for="regular2">Nama Stockpile</label>
  											</div>
                      </div>
                      <div class="col-md-1 col-lg-1 col-xl-1">
                      ...
                      <div class="col-md-3">
						...
						<div class="row">
							...
							<form class="form-horizontal" role="form" action ="<?php echo base_url('References/Stockpile/Delete_multiple'); ?>" method="post">
							<div class="col-lg-12">
													...
													<div class="modal-dialog" role="document">
														<div class="modal-content">
															...
															<div class="modal-footer">
																...
																<a> <?php echo anchor('References/Stockpile/Delete/'.$table->id,'<button type="button" class="btn btn-danger">Delete</button>') ?></a>
															</div>
														</div>
													</div>
												</div>
